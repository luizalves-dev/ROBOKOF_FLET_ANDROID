...
except ModuleNotFoundError:  # Android: rasterização opcional não embarcada
...
def get_page_image(
    ...
    if pypdfium2 is None:
        raise RuntimeError(
            "A visualização rasterizada de páginas não está disponível nesta edição Android. "
            "A extração textual e de tabelas continua disponível."
        )
